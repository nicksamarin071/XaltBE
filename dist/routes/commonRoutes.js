...
import { getAllProductController, getProductByCategoryIdController, getProductByNameController, searchProductController } from "../controllers/productControllers.js";
...
router.post("/send-email", reqValidator(EmailValidation), sendEmailController);
